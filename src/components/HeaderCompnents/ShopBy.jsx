            ...
            <div className="category-contain">
              <div className="category-left">
                <div className="header-category">
                  ...
                  <ul className="collapse-category show">
                    ...
                    <li>
                      <a href="category-page(left-sidebar).html">
                        <img
                          src="../assets/images/mega-store/header-category/1.png"
                          alt=""
                        />
                        furniture
                      </a>
                    ...
                    <li>
                      <a href="category-page(left-sidebar).html">
                        <img
                          src="../assets/images/mega-store/header-category/2.png"
                          alt=""
                        />
                        electronics
                      </a>
                    ...
                    <li>
                      <a href="category-page(left-sidebar).html">
                        <img
                          src="../assets/images/mega-store/header-category/3.png"
                          alt=""
                        />
                        fashion
                      </a>
                    ...
                    <li>
                      <a href="category-page(left-sidebar).html">
                        <img
                          src="../assets/images/mega-store/header-category/4.png"
                          alt=""
                        />
                        medicine
                      </a>
                    ...
                    <li>
                      <a href="category-page(left-sidebar).html">
                        <img
                          src="../assets/images/mega-store/header-category/6.png"
                          alt=""
                        />
                        cosmetic
                      </a>
                    ...
                    <li>
                      <a href="category-page(left-sidebar).html">
                        <img
                          src="../assets/images/mega-store/header-category/7.png"
                          alt=""
                        />
                        bicycle
                      </a>
                    ...
                    <li>
                      <a href="category-page(left-sidebar).html">
                        <img
                          src="../assets/images/mega-store/header-category/8.png"
                          alt=""
                        />
                        shoes
                      </a>
                    ...
                    <li>
                      <a href="category-page(left-sidebar).html">
                        <img
                          src="../assets/images/mega-store/header-category/9.png"
                          alt=""
                        />
                        sport
                      </a>
                    ...
                    <li>
                      <a href="category-page(left-sidebar).html">
                        <img
                          src="../assets/images/mega-store/header-category/10.png"
                          alt=""
                        />
                        gym
                      </a>
                    ...
                    <li>
                      <a href="category-page(left-sidebar).html">
                        <img
                          src="../assets/images/mega-store/header-category/11.png"
                          alt=""
                        />
                        grocery
                      </a>
